...
public class ArgumentParserBuilder {
    ...
    private boolean noDestConversionForArgs_ = false;
     ...
     * {@link Argument#getDest()}) from argument name.
     * </p>
     *
     * <p>
     ...
     * replacing "-" with "_" in argument name. This is the same
     ...
     * @return This builder.
     */
    public ArgumentParserBuilder noDestConversionForArgs(boolean flag) {
        noDestConversionForArgs_ = flag;
        return this;
    }
